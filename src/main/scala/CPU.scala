...
class CPU(ProgPath: String, debug : Boolean ) extends Module {
  ...
  //io.out :=PC(31,15)
  io.out(0) := registers.io.regs(7)(16)
  io.out(1) := registers.io.regs(7)(17)
  io.out(2) := registers.io.regs(7)(18)
  io.out(3) := registers.io.regs(7)(19)
  io.out(4) := registers.io.regs(7)(20)
  io.out(5) := registers.io.regs(7)(21)
  io.out(6) := registers.io.regs(7)(22)
  io.out(7) := registers.io.regs(7)(23)
  io.out(8) := registers.io.regs(7)(24)
  io.out(9) := registers.io.regs(7)(25)
  io.out(10) := registers.io.regs(7)(26)
  io.out(11) := registers.io.regs(7)(27)
  io.out(12) := registers.io.regs(7)(28)
  io.out(13) := registers.io.regs(7)(29)
  io.out(14) := registers.io.regs(7)(30)
  io.out(15) := registers.io.regs(7)(31)
